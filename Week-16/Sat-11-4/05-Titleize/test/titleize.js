...
describe("Test Case", function(){
  it("adding period", function(){
    expect(titleize("mr kenneth")).to.equal("Mr. Kenneth");
  });
  it("", function(){
    expect(titleize("")).to.equal("");
  });
  it("capitols and periods", function(){
    expect(titleize("ms fay lanoux")).to.equal("Ms. Fay Lanoux");
  });
});
