...
db.people.insert({"name": "Philip", "rownumber": "1", "OS":"Win", "hobbies":["video games", "rock climbing", "cars"]})
db.people.insert({"name": "Aaron", "rownumber": "1", "OS":"mac", "hobbies":["things", "stuff", "boats"]})
db.people.insert({"name": "john", "rownumber": "1", "OS":"mac", "hobbies":["s", "f", "ts"]})


db.people.find().pretty()

db.people.find({"name": "Philip"})
db.people.find({"OS": "mac"})
db.people.find({"hobbies": {$in: [hobby1]}})
